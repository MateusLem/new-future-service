...
public class TrailService {
    ...
    public void update(String id, Trail trail) {
        ...
        if (!repository.existsById(trail.getId())) {
            throw new EntityNotFoundException("Trail not found with id: " + trail.getId());
        }
    ...
    public void delete(String id) {
        ...
        if (!repository.existsById(trailId)) {
            throw new EntityNotFoundException("Trail not found with id: " + id);
        }
    ...
    public Trail findTrail(String id) {
        ...
        return repository.findById(trailId)
                .orElseThrow(() -> new EntityNotFoundException("Trail not found with id: " + id));
    }
}